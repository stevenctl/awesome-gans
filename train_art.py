...
from util import random_shapes

# First, we generate our OWN data
try:
    os.rmdir('dataset/shapes')
except:
    pass
os.mkdir('dataset/shapes')
for i in range(30):
    random_shapes().save('dataset/shapes/%s.jpg' % i)
...
train_x, test_x = load_jpeg_folder_split('./dataset/trent', test_portion=0.1)
train_y, test_y = load_jpeg_folder_split('./dataset/shapes', test_portion=0.1)
